...
public interface FileTransfer extends Closeable {
    ...
    public static final PropertyDescriptor BATCH_SIZE = new PropertyDescriptor.Builder()
        ...
        .defaultValue("500")
        .build();
    public static final PropertyDescriptor TRANSFER_WAIT = new PropertyDescriptor.Builder()
            .name("Transfer wait interval")
            .description("Seconds to wait for an FTP transfer to finish. Set to 0 to disable.")
            .required(true)
            .addValidator(StandardValidators.NON_NEGATIVE_INTEGER_VALIDATOR)
            .defaultValue("0")
            .build();
